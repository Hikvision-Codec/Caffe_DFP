...
Note that in the above website of Caffe_Baseeline, you can find the button named "comapre". With it, oen can directly observe the difference. Another way is that one can download Caffe_Basline and Caffe_DFP. With the help of SVN, it is easy to find the difference.
#### 2.2.3 Configuration:
