...
Note that in the above website of Caffe_Baseline, you can find the button named "compare". With it, one can directly observe the difference. Another way is that one can download Caffe_Baseline and Caffe_DFP. With the help of SVN, it is easy to find the difference.
#### 2.2.3 Configuration:
